        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4 text-neutral-500">
            <h1 className="text-neutral-500">
              We are <span className="font-bold">EOMR INDIA PVT LTD</span> (
            ...
            <h1>
              ...
              <BlueLink href="https://eomr.in">https://eomr.in</BlueLink> (the
              &apos;Site&apos;), as well as any other related products and
              services that refer or link to these legal terms (the &apos;Legal
              Terms&apos;) (collectively, the &apos;Services&apos;).
            </h1>
            <h1>
              We provide exam analysis and performance data of a mock test given
              by user, which help them in excelling in the exam.
            </h1>
            <h1>
              You can contact us by phone at 8955705452, email at
              contact@eomr.in, or by mail to 1502, 22nd Main Road, Agara
              Village, 1st Sector, HSR Layout, Bengaluru, Bengaluru, Karnataka
              560102, India.
            </h1>
            <h1>
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity
              (&apos;you&apos;), and EOMR India PVT LTD, concerning your access
          ...
          <div className="space-y-8">
            ...
            <div>
              <ul className="list-inside pl-2">
                ...
                <li>
                  <BlueLink href="#18">18. LIMITATIONS OF LIABILITY</BlueLink>
                </li>
                <li>
                  <BlueLink href="#19">19. INDEMNIFICATION</BlueLink>
                </li>
                <li>
                  <BlueLink href="#20">20. USER DATA</BlueLink>
                </li>
                <li>
                  <BlueLink href="#21">
                ...
                <li>
                  <BlueLink href="#22">22. REFUNDS AND CANCELLATIONS</BlueLink>
                </li>
                <li>
                  <BlueLink href="#23">23. MISCELLANEOUS</BlueLink>
                </li>
                <li>
                  <BlueLink href="#24">24. CONTACT US</BlueLink>
                </li>
              </ul>
            </div>
            <div className="space-y-8">
              ...
              <div className="space-y-4" id="2">
                ...
                <Heading>Your use of our Services</Heading>
                <h1>
                ...
                <h1>solely for your personal, non-commercial use.</h1>
                <h1>
                ...
                <h1>
                  ...
                  Legal Terms, please address your request to: contact@eomr.in.
              ...
              <div className="space-y-4" id="5">
                <Heading>5. PURCHASES AND PAYMENT</Heading>
                <h1>
                ...
                <h1>
                  ...
                  may change prices at any time. All payments shall be in INR.
                </h1>
                <h1>
                ...
                <h1>
                  ...
                  appear to be placed by relevant parties.
                </h1>
              </div>
              <div className="space-y-4" id="6">
                <Heading>6. PROHIBITED ACTIVITIES</Heading>
                <h1>
                ...
                <h1>As a user of the Services, you agree not to:</h1>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    ...
                    (&apos;gifs&apos;), 1X1 pixels, web bugs, cookies, or other
                  ...
                  <li>Finding malicious use of account</li>
                </ul>
              </div>
              <div className="space-y-4" id="7">
                <Heading>7. USER GENERATED CONTRIBUTIONS</Heading>
                <h1>
              ...
              <div className="space-y-4" id="8">
                <Heading>8. CONTRIBUTION LICENCE</Heading>
                <h1>
              ...
              <div className="space-y-4" id="9">
                <Heading>9. SOCIAL MEDIA</Heading>
                <h1>
              ...
              <div className="space-y-4" id="10">
                <Heading>10. SERVICES MANAGEMENT</Heading>
                <h1>
              ...
              <div className="space-y-4" id="11">
                ...
                <h1>
                  ...
                  to India, and you expressly consent to have your data
                  transferred to and processed in India.
                </h1>
              </div>
              <div className="space-y-4" id="12">
                <Heading>12. TERM AND TERMINATION</Heading>
                <h1>
              ...
              <div className="space-y-4" id="13">
                <Heading>13. MODIFICATIONS AND INTERRUPTIONS</Heading>
                <h1>
              ...
              <div className="space-y-4" id="14">
                <Heading>14. GOVERNING LAW</Heading>
                <h1>
                  These Legal Terms shall be governed by and defined following
                  the laws of India. EOMR India PVT LTD and yourself irrevocably
                  consent that the courts of India shall have exclusive
                  jurisdiction to resolve any dispute which may arise in
                  connection with these Legal Terms.
                </h1>
              </div>
              <div className="space-y-4" id="15">
                <Heading>15. DISPUTE RESOLUTION</Heading>
                <Heading>Informal Negotiations</Heading>
                <h1>
                ...
                <h1>
                  ...
                  (2). The seat, or legal place, or arbitration shall be
                  Bengaluru, India. The language of the proceedings shall be
                  English. The governing law of these Legal Terms shall be
                ...
                <h1>
                  ...
                  invasion of privacy, or unauthorised use; and (c) any claim
              ...
              <div className="space-y-4" id="16">
                <Heading>16. CORRECTIONS</Heading>
                <h1>
              ...
              <div className="space-y-4" id="17">
                <Heading>17. DISCLAIMER</Heading>
                <h1>
              ...
              <div className="space-y-4" id="18">
                <Heading>18. LIMITATIONS OF LIABILITY</Heading>
                <h1>
                  ...
                  (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR 1000
                  INR. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
              ...
              <div className="space-y-4" id="19">
                <Heading>19. INDEMNIFICATION</Heading>
                <h1>
              ...
              <div className="space-y-4" id="20">
                <Heading>20. USER DATA</Heading>
                <h1>
              ...
              <div className="space-y-4" id="22">
                <Heading>22. REFUNDS AND CANCELLATIONS</Heading>
                <h1>
                  You are entitled to cancel Your Order within 7 days without
                  giving any reason for doing so.
                </h1>
                <h1>
                  The deadline for applying the refund is 7 days from the day of
                  your payment.
                </h1>
                <h1>
                ...
                <ul className="list-disc list-inside">
                  <li>
                    If you haven&apos;t attempted any test from the module of
                    which you have made payment.
                  </li>
                  <li>
                    If you have intimate us within 7 days of the date of your
                    purchase.
                  </li>
                </ul>

                <h1>
                  If you satisfy above conditions, we will process your refund
                  within the next 7 days of approving of your request of refund.
                </h1>
                <h1>
                  We reserve the right to not reimburse the refund in case we
                  found irregularities, fraud, or any other reason.{" "}
                </h1>
                <h1>
                  If you have any questions about our Returns and Refunds
                  Policy, please contact us by email: refunds@eomr.in
                </h1>
              </div>
              <div className="space-y-4" id="23">
                <Heading>23. MISCELLANEOUS</Heading>
                <h1>
              ...
              <div className="space-y-4" id="24">
                <Heading>24. CONTACT US</Heading>
                <h1>
                ...
                <h1>Phone: 8955705452 contact@eomr.in</h1>
              </div>
            </div>
          </div>
        </div>
